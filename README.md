...
What you learn about [Django](https://docs.djangoproject.com/en/2.2/) is aslo can be use 
Qyou know about Django is also able to use in the Django-RESTful framework because of this framework is based on the Django. Sometimes, if you think the built-in functions in this framework is not good to use or not fit your requirement,  handling problems in the Django's way is an alternative way to try. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUzNzkzNjMxNCwtMTc1MDAxNjkwOCwtMT
